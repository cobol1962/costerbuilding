loadedPages.search = {
  ...
  drawSearch: function(res) {
    ...
    /*  $(".recycling").unbind("click");
      ...
      $('<button type="button" id="ati" data-dismiss="modal" style="" onclick="loadedPages.search.confirmAddToInvoice1(this);" class="btn-bigblack"><span style="width:100%;text-align:left;margin-top:5px;">ADD TO BAG</span></button>').appendTo($("#items_div"));
  ...
  confirmAddToInvoice1: function(obj) {

    var oo = $(obj).closest("#items_div").find(".recycling");
  ...
  checkAddToInvoice(obj) {
      ...
      if ($('#item_serials_body').find(".selected").length == 0 && obj === undefined) {
          ...
          api.call("getItemBySerial", function(res) {
              ...
              var ob = {
                  imageURL: "<img style='width:100px;height:auto;' src='https://costercatalog.com/catalog/images/" + data.ImageName + "' />",
                  img: "<img style='width:250px;height:auto;' src='https://costercatalog.com/catalog/images/" + data.ImageName + "' />",
              ...
              window.parent.postMessage("addToInvoice#" + JSON.stringify(ob), "*");
            } catch(err) {
              alert(err);
            }
          }, dd, {}, {});
  ...
  showProductInfo: function(o) {
    var obj = $(o);
      ...
      api.call("getItemByIdSearch", function(res) {
          ...
          var img = $("<img src='https://costercatalog.com/catalog/images/" + data.ImageName + "' style='height:auto;'/>");
