            ...
            confirmCallback: function() {
                ...
                api.call("getScannedProduct", function(res) {
                    if (res[0] == undefined) {
                        ...
                        if (res[0].imageURL != "") {
                            var img = $("<img src='https://costercatalog.com/catalog/images/" + res[0].imageURL + "' style='width:100px;' />");
                        }
...
function openPDF(data) {
    ...
    $.ajax({
        url: "http://costercatalog.com:81/api/invoice.php?invoice=" + data,
        type: "GET",
        success: function(res) {
            var app = document.URL.indexOf('http://') === -1 && document.URL.indexOf('https://') === -1;
